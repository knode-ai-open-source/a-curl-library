...
static void parse_openai_chat_response(curl_output_interface_t *userdata, curl_event_request_t *req) {
    openai_chat_output_t *output = (openai_chat_output_t *)userdata;
...
// **Failure Callback**
static void chat_on_failure(CURLcode result, long http_code, curl_output_interface_t *userdata, curl_event_request_t *req) {
    openai_chat_output_t *output = (openai_chat_output_t *)userdata;
