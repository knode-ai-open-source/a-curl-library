...
#include "a-curl-library/outputs/openai/v1/chat/completions.h"
...
} openai_v1_chat_completions_output_t;
...
static size_t chat_write_callback(const void *data, size_t size, size_t nmemb, curl_output_interface_t *interface) {
    openai_v1_chat_completions_output_t *output = (openai_v1_chat_completions_output_t *)interface;
...
static void parse_openai_v1_chat_completions_response(curl_output_interface_t *output_data, curl_event_request_t *req) {
    openai_v1_chat_completions_output_t *output = (openai_v1_chat_completions_output_t *)output_data;
...
curl_output_interface_t *openai_v1_chat_completions_output(
    ...
    openai_v1_chat_completions_output_t *output = aml_calloc(1, sizeof(openai_v1_chat_completions_output_t));
    ...
    output->interface.complete = parse_openai_v1_chat_completions_response;
