...
static size_t default_on_write(void *data, size_t size, size_t nmemb, curl_event_request_t *req) {
    curl_output_interface_t *output = (curl_output_interface_t *)req->output_data;
    if(output) {
...
static void default_output_destroy(void *output_data) {
    curl_output_interface_t *output = (curl_output_interface_t *)output_data;
...
void curl_output_defaults(curl_event_request_t *req, curl_output_interface_t *output) {
    ...
    req->output_data_cleanup = default_output_destroy;
